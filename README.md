...
- A background sync runs every five minutes by default (`SYNC_INTERVAL_SECONDS`) and imports each connected proxy account. Settings can persistently enable or pause it and set a 1–1,440-minute interval; the environment value remains the initial default.
